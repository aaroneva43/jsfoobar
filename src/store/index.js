...
const data = {
  ...
  mutations: {
    ...
    setHeartbeat(state, status) {
      state.isHeartbeat = status;
    },
    setSoftdog(state, status) {
      state.isSoftdog = status;
    },
    ...
    // 登录
    setSoftdog({ commit }, data) {
      return new Promise((resolve) => {

        commit('setSoftdog', data)
        resolve()
      })
    },
    // 登录
    setHeartbeat({ commit }, data) {
      return new Promise((resolve) => {
        commit('setHeartbeat', data)
        resolve()
      })
    },
  }
